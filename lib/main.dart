                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: ReuasbleCard(seatn: '28', seatpos: 'Lower',seatSelect: seatSel,),
                            ),
                            Expanded(
                              child: ReuasbleCard(seatn: '29', seatpos: 'Middle',seatSelect: seatSel,),
                            ),
                            Expanded(
                              child: ReuasbleCard(seatn: '30', seatpos: 'Upper',seatSelect: seatSel,),
                            ),
                            SizedBox(
                              width: 40,
                            ),
                            Expanded(
                              child: ReuasbleCard(seatn: '32', seatpos: 'Side Lower',seatSelect: seatSel,),
                            ),
                          ],
                        ),
                      ),
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Expanded(
                              child: ReuasbleCard(seatn: '33', seatpos: 'Lower',seatSelect: seatSel,),
                            ),
                            Expanded(
                              child: ReuasbleCard(seatn: '34', seatpos: 'Middle',seatSelect: seatSel,),
                            ),
                            Expanded(
                              child: ReuasbleCard(seatn: '35', seatpos: 'Upper',seatSelect: seatSel,),
                            ),
                            SizedBox(
                              width: 40,
                            ),
                            Expanded(
                              child: ReuasbleCard(seatn: '39', seatpos: 'Side Upper',seatSelect: seatSel,),
                            ),
                          ],
                        ),
                      ),
